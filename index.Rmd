...
chart3
```
This chart is suppose to show the mean income per person in all the continents from 2006 to 2016. The reason why we include this chart is because it can represent each continents' economy through income each person have in a year. Income is directly related to educational opportunity. Overall, we can see that Africa has the lowest income per person in all continents. Oceania and Europe have the first two highest mean income per person from 2006 to 2016. Both continents have great education systems. One more information we can get is that mean income per person increased in all continents but Africa.
...
# Code below will generate summary information of the datasets, including 7 calculated observations
