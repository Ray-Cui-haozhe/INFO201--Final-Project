...
# Extract only the earning and education level information for certain country,
...
# Question 1 --------------------------------------------------------------
# What's the correlation between GDP/capita and education level?
# We will be using household earning as our primary assessment for capita. The
# variables in the data shows the percentage of people who's income is estimated 
# based on its country's median household income. 
  
  output$scatter <- renderPlotly({
    edu_gdp <- education_earnings %>%
      filter(Country == input$country & year == 2018 & Earning_category == input$capita)
